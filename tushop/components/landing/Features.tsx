    ...
    <section id="features" className="section-margin">
      <div className="space-y-8">
        ...
        <div className="flex flex-col items-center justify-center space-y-2 text-center md:space-y-3">
          <h3 className="landing-section-title">Warehouse Management Features</h3>
          <p className="landing-section-description max-w-[650px]">
            Optimize your logistics operations with our comprehensive suite of warehouse management tools.
          </p>
        </div>
        ...
        <div className="w-full">
          <div className="grid gap-x-3 gap-y-5 md:grid-cols-2 lg:grid-cols-3">
            {featuresList.map((feature) => (
              <div
                key={feature.title}
                className="space-y-3 rounded-2xl bg-[#2e2e2e] p-4 transition-all hover:scale-[1.02] hover:bg-[#3a3a3a]"
              >
